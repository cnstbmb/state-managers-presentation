...
import { viewModeAtom, favoriteOrdersAtom } from './atoms/orderAtoms';
import { errorAtom } from './atoms/uiAtoms';
import './App.css';

function App() {
    const viewMode = useAtomValue(viewModeAtom);
    const error = useAtomValue(errorAtom);
    const favoriteOrders = useAtomValue(favoriteOrdersAtom);

    return (
        <div className="app">
            <header className="app-header">
                <h1>📦 Отслеживание заказов (Jotai)</h1>
