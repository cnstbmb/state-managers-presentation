...
import { viewModeAtom, favoriteOrdersAtom } from './stores/orderStores';
import { errorAtom } from './stores/uiStores';
import './App.css';

function App() {
    const viewMode = useStore(viewModeAtom);
    const error = useStore(errorAtom);
    const favoriteOrders = useStore(favoriteOrdersAtom);

    return (
        <div className="app">
            <header className="app-header">
                <h1>📦 Отслеживание заказов (NanoStores)</h1>
