...
import {currentOrderSelector, isOrderFavoriteSelector} from '../selectors/orderSelectors';
...
export const OrderDetails = () => {
    ...
    const isFavorite = useRecoilValue(isOrderFavoriteSelector(currentOrderId));
    const {toggleFavorite, fetchOrder, updateOrderStatus} = useOrders();

    if (!currentOrder) {
        return (<div className="order-details-empty">
    ...
    return (<div className="order-details">
            ...
            <div className="order-progress">
                ...
                <div className="progress-steps">
                    {currentOrder.steps.map((step, idx) => (<div
                            key={idx}
                        ...
                        >
                            ...
                            <div className="step-info">
                                ...
                                {step.time && (<div className="step-time">
            ...
            <div className="order-actions">
                ...
                {currentOrder.status !== 'delivered' && (<select
