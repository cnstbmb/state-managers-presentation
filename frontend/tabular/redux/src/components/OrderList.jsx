...
import { useFilteredOrders, useOrdersState } from '../hooks/useOrderSelectors';
import { useOrderActions } from '../hooks/useOrderActions';

export const OrderList = () => {
    const filteredOrders = useFilteredOrders();
    const { filters, pagination, loading, favorites } = useOrdersState();
    const { fetchOrders, fetchOrder, toggleFavorite, updateFilters, setViewMode } = useOrderActions();
