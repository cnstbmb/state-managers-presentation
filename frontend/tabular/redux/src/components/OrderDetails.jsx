...
import { useCurrentOrder, useOrdersState } from '../hooks/useOrderSelectors';
import { useOrderActions } from '../hooks/useOrderActions';

export const OrderDetails = () => {
    const currentOrder = useCurrentOrder();
    const { favorites } = useOrdersState();
    const { toggleFavorite, fetchOrder, updateOrderStatus } = useOrderActions();
    ...
    const isOrderFavorite = favorites.includes(currentOrder.id);
